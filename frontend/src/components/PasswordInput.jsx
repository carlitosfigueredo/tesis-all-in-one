    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className={`w-full rounded-lg border border-gray-300 px-4 py-2.5 pr-11 text-sm transition-colors focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20 ${className}`}
        />
        <button
          type="button"
          onClick={() => setShow((v) => !v)}
