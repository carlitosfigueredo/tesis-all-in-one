  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mb-12">
          <h1 className="text-4xl font-extrabold text-gray-900 dark:text-gray-100">Aviso legal</h1>
          <p className="mt-3 text-sm text-gray-400 dark:text-gray-500">Última actualización: julio de 2026</p>
